...
class Resnet_Base(nn.Module):
    def __init__(self, block, num_blocks, num_classes):
        ...
        self.layer1_ = self._make_layer_1(block, 64, num_blocks[0], stride=2)
        self.layer2_ = self._make_layer_1(block, 128, num_blocks[1], stride=2)
        self.layer3_ = self._make_layer_1(block, 256, num_blocks[2], stride=2)
        self.layer4_ = self._make_layer_1(block, 512, num_blocks[3], stride=2)
