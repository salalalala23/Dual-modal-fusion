...
class Net2(nn.Module):
    def __init__(self, num_classes=12):
        ...
        self.fc = nn.Linear(in_features=3072, out_features=num_classes)
    ...
    def forward(self, hsi, lidar):
        ...
        # a, b = f1.size(0), f1.size(1)
        # print(f1.size(), f2.size(), f3.size())
        # FC = nn.Linear(in_features=b*3, out_features=11).cuda()
...
def Net(args):
    return Net2(args['Categories_Number'])
